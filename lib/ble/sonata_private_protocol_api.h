...
/// rx callback
typedef uint8_t (*PF_SONATA_2_4G_RX_CALLBACK)(uint8_t *data,uint8_t length);

/// tx callback
typedef uint8_t (*PF_SONATA_2_4G_TX_CALLBACK)(uint8_t status);

/// timeout callback
typedef uint8_t (*PF_SONATA_2_4G_TIMEOUT_CALLBACK)(uint8_t status);
